...
export default function Login() {
  ...
  headers: { 
    ...
    "Accept": "application/json" // <--- JANGAN LUPA INI
  },
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <div className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl shadow-2xl">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-gray-400">Lanjutkan perjalanan impian Anda.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {isLoading ? <Loader2 className="animate-spin h-5 w-5" /> : "Masuk Akun"}
            </button>
          </form>

          <p className="mt-8 text-center text-sm text-gray-400">
            Belum punya akun?{" "}
            <Link href="/register" className="text-white hover:text-orange-400 hover:underline">
              Daftar di sini
            </Link>
          </p>
        </div>
